...
export const redirectGoogleOBSURl = `http://localhost:3001/auth/googleOBS`
...
export const TAURI_SETTING_FILE = 'settings.json'
export const TAURI_SETTING_KEY = 'clientId'
